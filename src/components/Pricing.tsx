    ...
    <section id="pricing" className="py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Enterprise VIP Plan */}
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow relative overflow-hidden">
