...
const teamMembers: TeamMember[] = [
  {
    name: "Jay Lin",
    title: "AI 广告策略专家",
    description: "前 Meta AI 专家，拥有超过10年数字营销经验。专注于利用人工智能技术优化广告投放策略，帮助客户实现最佳广告效果。",
  ...
  },
  {
    name: "Helen Lan",
    title: "高级商务发展总监",
    description: "资深商务发展专家，深谙国际销售策略。擅长制定跨境营销方案，帮助企业开拓国际市场，建立品牌影响力。",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {teamMembers.map((member) => (
            <div key={member.name} className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-${member.color}-600 font-semibold mt-1`}>{member.title}</p>
